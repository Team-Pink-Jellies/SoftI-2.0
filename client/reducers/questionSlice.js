...
const initialState = {
  questions: [
    ...
    "Discuss any positive contributions you've made to your previous organization, be as specific as possible with real world examples.",
  ],
  questionSet: [],
  isLoggedIn: false,
...
export const { display, userLogin, startSession, nextQuestion, endSession } =
